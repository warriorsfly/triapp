...
class FragmentReportDetail(private val details:List<ReportDetail>) : BottomSheetDialogFragment() {


    lateinit var adapter: AtomNoneAdapter<ReportDetail, ItemReportItemBinding>
    ...
    override fun onCreateView(
        ...
        adapter = object : AtomNoneAdapter<ReportDetail, ItemReportItemBinding>(
            ...
            override fun onBindViewHolder(
                holder: AtomViewHolder<ItemReportItemBinding>,
                position: Int
            ) {
            ...
            override fun onCreateViewHolder(
                parent: ViewGroup,
                viewType: Int
            ): AtomViewHolder<ItemReportItemBinding> {
                val binding =
                    ItemReportItemBinding.inflate(
